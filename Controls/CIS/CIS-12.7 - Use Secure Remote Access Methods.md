...
control_name: "Use Secure Remote Access Methods"
priority: 4
priority_label: "High"
baseline: true
...
# CIS-12.7 - Use Secure Remote Access Methods
...
Ensure remote devices utilize a VPN and are connecting to an enterprise AAA infrastructure.
