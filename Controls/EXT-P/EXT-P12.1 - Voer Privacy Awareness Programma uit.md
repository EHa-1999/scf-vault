...
type: control
category: "EXT-P12"
category_name: "Privacy Awareness en Training"
control_name: "Voer Privacy Awareness Programma uit"
priority: 4
priority_label: "High"
baseline: true
...
# EXT-P12.1 - Voer Privacy Awareness Programma uit
...
|------------|--------|
| **ID** | EXT-P12.1 |
| **Categorie** | EXT-P12 - Privacy Awareness en Training |
| **Prioriteit** | 4 (High) |
| **Type** | Organizational |
...
| [[Frameworks/AVG-GDPR|AVG/GDPR]] | Art.39(1)(b) |
...
Train medewerkers regelmatig in privacy-principes, -procedures en hun verantwoordelijkheden.
