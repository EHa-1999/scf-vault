...
type: control
category: "EXT-P2"
category_name: "Data Protection Impact Assessment"
control_name: "Voer DPIA uit en documenteer resultaten"
priority: 4
priority_label: "High"
baseline: true
...
# EXT-P2.2 - Voer DPIA uit en documenteer resultaten
...
|------------|--------|
| **ID** | EXT-P2.2 |
| **Categorie** | EXT-P2 - Data Protection Impact Assessment |
| **Prioriteit** | 4 (High) |
| **Type** | Organizational |
...
| [[Frameworks/BIO2|BIO2]] | 5.07 |
| [[Frameworks/AVG-GDPR|AVG/GDPR]] | Art.35 |
...
Voer DPIA's uit voor hoog-risico verwerkingen en documenteer de resultaten, risico's en mitigerende maatregelen.
