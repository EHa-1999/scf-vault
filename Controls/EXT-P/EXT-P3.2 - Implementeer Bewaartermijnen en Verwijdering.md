...
type: control
category: "EXT-P3"
category_name: "Dataminimalisatie (MINIMALISEER)"
control_name: "Implementeer Bewaartermijnen en Verwijdering"
priority: 4
priority_label: "High"
baseline: true
...
# EXT-P3.2 - Implementeer Bewaartermijnen en Verwijdering
...
|------------|--------|
| **ID** | EXT-P3.2 |
| **Categorie** | EXT-P3 - Dataminimalisatie (MINIMALISEER) |
| **Prioriteit** | 4 (High) |
| **Type** | Organizational |
...
| [[Frameworks/AVG-GDPR|AVG/GDPR]] | Art.5(1)(e) |
...
Definieer en handhaaf bewaartermijnen voor persoonsgegevens en zorg voor veilige verwijdering na afloop.
