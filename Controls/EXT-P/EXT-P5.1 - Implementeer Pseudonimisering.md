...
control_name: "Implementeer Pseudonimisering"
priority: 4
priority_label: "High"
baseline: true
...
# EXT-P5.1 - Implementeer Pseudonimisering
...
| [[Frameworks/AVG-GDPR|AVG/GDPR]] | Art.4(5) |
...
Pas pseudonimisering toe waar mogelijk om directe identificatie te voorkomen.
