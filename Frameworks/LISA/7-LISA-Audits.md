...
| 3. Data Protection | Systeem | Per systeem waar data wordt verwerkt |
| 4. Secure Configuration | Systeem | Per component binnen systeem |
| 5. Account Management | Systeem + Domein | Systeem-specifiek + centraal IAM |
...
| 11. Data Recovery | Systeem | Per systeem |
...
| 15. Service Provider Management | Domein | Organisatie-breed |
| 16. Application Security | Systeem | Per applicatie |
| 17. Incident Response | Domein | Organisatie-breed |
| 18. Penetration Testing | Domein + Systeem | Organisatie-breed + per systeem |
...
LISA gebruikt een audit-dossier structuur waarbij alle documenten van één audit bij elkaar staan:
...
- [[Audits/Templates/System-Assessment-Template|Systeem Assessment Template]]
