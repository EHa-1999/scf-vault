...
type: control
category: "CIS 1"
category_name: "Inventarisatie en Beheer van Bedrijfsmiddelen"
control_name: "Gebruik Actieve Detectietools"
priority: 4
priority_label: "High"
baseline: false
control_type: "Basic"
...
# CIS-1.3 - Gebruik Actieve Detectietools

## Overzicht

| Eigenschap | Waarde |
|------------|--------|
| **Categorie** | Inventarisatie en Beheer van Bedrijfsmiddelen |
| **Prioriteit** | 4 - High |
| **Type** | Basic |
...
Utilize an active discovery tool to identify assets connected to the enterprise network.
