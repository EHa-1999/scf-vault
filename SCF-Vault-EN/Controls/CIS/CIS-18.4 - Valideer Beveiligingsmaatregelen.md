...
type: control
category: "CIS 18"
category_name: "Penetratietesten"
control_name: "Valideer Beveiligingsmaatregelen"
priority: 3
...
# CIS-18.4 - Valideer Beveiligingsmaatregelen

## Overzicht

| Eigenschap | Waarde |
|------------|--------|
| **Categorie** | Penetratietesten |
| **Prioriteit** | 3 - Medium |
| **Type** | Organizational |
...
|-----------|------------|
| [[Frameworks/ISO-27001-2022|ISO 27001:2022]] | A.8.30 |
...
Deze control draagt bij aan het mitigeren van risico's gerelateerd aan penetration testing.
