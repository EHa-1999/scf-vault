...
control_name: "Beheer Whitelist van Bibliotheken"
priority: 2
priority_label: "Low"
baseline: false
...
# CIS-2.6 - Beheer Whitelist van Bibliotheken
...
Use technical controls to ensure that only authorized software can execute on enterprise assets.
