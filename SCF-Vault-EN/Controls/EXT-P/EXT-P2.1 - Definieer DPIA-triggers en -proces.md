...
control_name: "Definieer DPIA-triggers en -proces"
priority: 5
...
# EXT-P2.1 - Definieer DPIA-triggers en -proces
...
Definieer criteria wanneer een Data Protection Impact Assessment (DPIA) verplicht is en het proces voor uitvoering.
